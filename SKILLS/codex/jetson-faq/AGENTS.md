...
→ See skill: `codex/jetpack-flash-wsl2` or Seeed wiki troubleshooting guide
...
→ See skill: `codex/usb-timeout-during-flashing`
...
→ See skill: `codex/jetpack5-ssd-boot-fix`

### Q14: How to build Seeed's Jetson BSP from source
→ See skill: `codex/bsp-source-build`
...
→ See skill: `codex/ko-module-build`
...
→ See skill: `codex/ethercat-communication`
